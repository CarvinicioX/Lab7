...
Secuestro::Secuestro(int numCaso,vector<Persona*> Invest,vector<Evidencia*> Evidence,string incidente,string fechaIncidente,bool cerrado,string nom_victima,string lugar_s,string motivo,int cant,bool rescate,bool estado)
